(function () {
  ...
  ov.innerHTML = '<div class="szukaj-box"><input type="search" class="szukaj-input" placeholder="Search articles..." autocomplete="off"><div class="szukaj-wyniki"></div></div>';
  ...
  input.addEventListener('input', function () {
    ...
    if (res.length === 0) { wyniki.innerHTML = '<div class="szukaj-brak">No results found</div>'; return; }
